...
class AddVehiclePucFragment :  BaseFragment() , ListnerForDialog {
    ...
    override fun onCreateView(
        ...
        view.tv_add_puc.text=getString(R.string.add_puc)
        view.tv_addphoto_puc.text=getString(R.string.attach_puc_photo)
    ...
    private fun uploadingUserPhoto() {
        ...
        mCompositeDisposable_update_Photo?.add(
            ApiRequestClient.createREtrofitInstance()
                .uploadImageForVehiclePuc(body, adminid, vehicleid, permitValidDate,type)
