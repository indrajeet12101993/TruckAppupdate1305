...
class AddDriverAdressFragment : BaseFragment() , ListnerForDialog {
    override fun selctok() {
        activity!!.supportFragmentManager.popBackStack()
        AppConstants.ISDONE4 ="done"
    }
    ...
    override fun onCreateView(
        ...
        view.tv_attach.text=getString(R.string.attach_current_address_proof_with_photo)
    ...
    private fun uploadingUserPhoto() {
        ...
        mCompositeDisposable_update_Photo?.add(
            ApiRequestClient.createREtrofitInstance()
                .uploadImageForAdressPhoto(body, id,  type)
