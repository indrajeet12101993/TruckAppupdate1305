...
class AddFitnessVehichleFragment :  BaseFragment() , ListnerForDialog {
    ...
    override fun onCreateView(
        ...
        view.tv_fitness.text=getString(R.string.add_fitness_validity)
        view.tv_fitness_photo.text=getString(R.string.attach_fitness_validity_photo)
    ...
    private fun uploadingUserPhoto() {
        ...
        val finessNumber: RequestBody = RequestBody.create(MediaType.parse("text/plain"),mFinessNumber)
        ...
        mCompositeDisposable_update_Photo?.add(
            ApiRequestClient.createREtrofitInstance()
                .uploadImageForVehicleFitness(body, adminid, vehicleid,finessNumber, permitValidDate,type)
